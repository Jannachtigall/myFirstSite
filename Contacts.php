...
<body>
  ...
  $result = $mysql->query("SELECT * FROM `Авторы`");
    ...
    <div class="container my-5">
      ...
      <?php while ($data = $result->fetch_assoc()) { ?>
        <div class="card mb-3" style="max-width: 100%;">
          <div class="row g-0">
            <div class="col-lg-3">
              <img src="<?php echo $data['Photo']; ?>" class="img-fluid rounded-start" alt="...">
            </div>
            <div class="col-lg-9">
              <div class="card-body">
                <h5 class="card-title"><b><?php echo $data['Name']; ?></b></h5>
                <p class="card-text"><?php echo $data['Personal_data']; ?>;
                  <br>
                  <?= $data['Academic_data']; ?>.
                </p>
                <p><img src="images/phone.png" alt="..." width="22" height="22"> Телефон: <?php echo $data['Phone_number']; ?></p>
                <p><img src="images/gmail.png" alt="..." width="22" height="22"> Электронная почта: <a href="#" style="text-decoration: none;"><?php echo $data['Email']; ?></a></p>
                <p><img src="images/github.png" alt="..." width="22" height="22"> GitHub: <a href="https://github.com/<?php echo $data['Github']; ?>" style="text-decoration: none;"><?php echo $data['Github']; ?></a></p>
              </div>
            </div>
          </div>
        </div>
